...
if (isset($_POST['submit'])) {
    ...
    UPDATE `testimonial` SET `image`=:image,`name`=:name,`comment`=:comment WHERE id=$id
    ");
            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link active" href="../testimonial/index.php" aria-expanded="false">
                                <span>
                                    <i class="ti ti-file-description"></i>
                                </span>
                                <span class="hide-menu">testimonial/edit</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
