...
if (isset($_POST['submit'])) {
    ...
    UPDATE `courses` SET `image`=:image,`price`=:price,`category`=:category,`title`=:title,`text`=:text,`teacher_img`=:teacher_img,`name`=:name,`students`=:students,`likes`=:likes WHERE id=$id
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link active" href="../courses/index.php" aria-expanded="false">
                                ...
                                <span class="hide-menu">Courses/edit</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
            ...
            <div class="col-12">
                <form action="edit.php?id=<?= $data['id'] ?>" method="post" autocomplete="off"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" value="<?= $data['image'] ?>" id="image1" name="image1">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="price">Price</label>
                        <input class="form-control" type="text" id="price" value="<?= $data['price'] ?>" name="price"
                            placeholder="Enter price">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="category">Category</label>
                        <input class="form-control" type="text" id="category" value="<?= $data['category'] ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="text" name="text" value="<?= $data['text'] ?>"
                            placeholder="Enter text">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="image2">Teacher Image</label>
                        <input class="form-control" type="file" id="image2" value="<?= $data['teacher_img'] ?>"
                            name="image2">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="name">Teacher Name</label>
                        <input class="form-control" type="text" value="<?= $data['name'] ?>" id="name" value="0"
                            name="name" placeholder="Enter name">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="students">Students</label>
                        <input class="form-control" type="number" id="students" value="<?= $data['students'] ?>"
                            name="students" placeholder="Enter students">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="likes">Likes</label>
                        <input class="form-control" type="number" value="<?= $data['likes'] ?>" id="likes" value="0"
                            name="likes" placeholder="Enter likes">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="time">time</label>
                        <input class="form-control" type="number" value="<?= $data['time'] ?>" id="time" value="0"
