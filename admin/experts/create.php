...
if (isset($_POST['submit'])) {
    ...
    INSERT INTO `experts`
    (`image`, `name`, `position`, `comment`, `facebook`, `twitter`, `linkedin`, `social`)
     VALUES 
    (:image,:name,:position,:comment,:facebook,:twitter,:linkedin,:social)");
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link active" href="../experts/index.php" aria-expanded="false">
                                ...
                                <span class="hide-menu">Expert Trainers/create</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                    ...
                    <div class="col-12">
                        <form action="create.php" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="facebook" id="facebook" name="facebook"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="social" name="social"
