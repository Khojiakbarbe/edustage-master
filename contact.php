...
$pdoAddress = $pdo->prepare("
SELECT * FROM `address`
");
$pdoAddress->execute();
$pdoData = $pdoAddress->fetch();
...
if (isset($_POST['submit'])) {
  ...
  $messageSent = $pdo->prepare("
  INSERT INTO `message`(`name`, `email`, `subject`, `text`) VALUES (:name,:email,:subject,:text)
  ");

  $messageSent->bindParam('name', $name);
  $messageSent->bindParam('email', $email);
  $messageSent->bindParam('subject', $subject);
  $messageSent->bindParam('text', $message);
  ...
  <section class="contact_area section_gap">
    <div class="container">
      ...
      <div class="row">
          ...
          <div class="contact_info">
            ...
            <div class="info_item">
              ...
              <p>
                <?= $pdoData['day_from'] ?> to
                <?= $pdoData['day_until'] ?>
                <?= $pdoData['call_time_from'] ?>am to
                <?= $pdoData['call_time_until'] ?> pm
              </p>
            </div>
            <div class="info_item">
              <i class="ti-email"></i>
        ...
        <div class="col-lg-9">
          <form action="contact.php" method="post" class="row contact_form">
            <div class="col-md-6">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 single-footer-widget">
          ...
          <div class="form-wrap" >
            <form action="contact.php" method="post" class="form-inlin">
